...
import home.joci.spring.validation.CourseCode;
...
public class Customer {
	...
	@Max(value=10, message="must be less or equals to ten")
	private Integer freePasses;
	
	@Pattern(regexp="^[a-zA-Z0-9]{5}", message="only 5 charcters/digits")
